...
a = 0.0125;                       params(5) = a; % space clearance rate

h = 0.05;                        params(6) = h; % handling time

e = 0.1;                        params(7) = e; % conversion efficiency

m = 0.6;                        params(8) = m; % predator per capita mortality

% set up for GEM

cv_vector = [0 0 0 0 0.8 0.4 0 0];

h2_vector = [0 0 0 0 0.6 0.6 0 0];
...
[t1,y1] = ode45(ode, tspan, y0);
    ...
    averagestart(1,1:2) = [round(mean(y1(100:113,1))), round(mean(y1(100:113,2)))];
